...
Structured pruning~\cite{sparsegpt,wanda,llmpruner, h2o,quest,pyramidkv} similarly alter tensor shapes without considering hardware alignment.
...
\noindent \textbf{Hardware-aware optimization.}
