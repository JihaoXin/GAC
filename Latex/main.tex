...
We evaluate on Llama-3-8B~\citep{llama3} with $\rho=15\%$, using PyTorch~2.9.1, CUDA~12.8, and FP16. Experiments were conducted on two architectures: NVIDIA Ampere (A100-80GB) and Hopper (H100-80GB). Unless stated otherwise, the results are collected from A100.
We also repeated some experiments on H100, which confirmed similar patterns (see Appendix~\ref{app:h100}).
...
Specialized devices, e.g., DGX Spark and Jetson Nano, adding further constraints.
