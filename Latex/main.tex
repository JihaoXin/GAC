...
We evaluate on Llama-3-8B~\citep{llama3} with $\rho=15\%$ using an NVIDIA A100-80GB with PyTorch 2.9.1, CUDA 12.8, FP16. We also conduct experiments on an NVIDIA H100-80GB (Hopper architecture), with detailed results provided in Appendix~\ref{app:h100}.
...
All experiments use Ampere (A100) by default, with Hopper (H100) results provided in Appendix~\ref{app:h100}.
